...
const Meessage_1 = require("../entities/Meessage");
...
const repository = DataSource_1.default.getRepository(Meessage_1.Message);
exports.default = new MessageRepository(repository);
